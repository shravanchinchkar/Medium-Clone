...
userRouter.post("/signup", (c) => c.text("Hello signup!"));
userRouter.post("/signin", (c) => c.text("Hello signin!"));

// src/routes/blog.ts
var blogRouter = new Hono2().basePath("/blogs");
blogRouter.post("/", (c) => c.text("Blog post!"));
blogRouter.put("/", (c) => c.text("blog change!"));
blogRouter.get("/:id", (c) => c.text("get the blog of id!"));
...
// .wrangler/tmp/bundle-B793aS/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-B793aS/middleware-loader.entry.ts
