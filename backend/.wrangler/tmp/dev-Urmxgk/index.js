...
var require_edge2 = __commonJS({
  "node_modules/.pnpm/@prisma+client@6.3.0_prisma@6.3.0/node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      ...
      "inlineSchemaHash": "1117e7cbd9358e87353769d60d0cd379107e356c50290c0df7fb9d99a621304b",
      "copyEngine": false
    };
    config.dirname = "/";
...
// .wrangler/tmp/bundle-J3Fa6i/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-J3Fa6i/middleware-insertion-facade.js
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  ...
  if (checkEmail) {
    c.status(403);
    c.json({ message: "Email already exists!" });
  } else {
    ...
    const token = sign2({ id: user.id }, c.env.JWT_SECRET);
    return c.json({
      //return the token
      token
    });
