  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-[0.5rem] ">
        ...
        <div className="text-center text-[#331922] font-bold text-3xl">
          {title}
        </div>
        {/* Following is the subtitle of the card */}
        <div className="flex justify-center gap-[0.3rem]">
          <div className="text-center font-semibold text-[#331922]">
            {subtitle}
          </div>
          <Link
            className="underline text-[#331922] font-semibold"
            to={to}
          >
            {buttonName}
          </Link>
